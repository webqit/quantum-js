...
export const astNodes = {
    ...
    switchStmt( discriminant, cases, lexical = false ) { return { type: 'SwitchStatement', discriminant, cases, lexical }; },
    ...
    funcDeclaration( params, body, async = false, id = null, expression = false, generator = false ) {
    ...
    funcExpr( params, body, async = false, id = null, expression = false, generator = false ) {
        return this.func( 'FunctionExpression', ...arguments );
    },
    arrowFuncExpr( params, body, async = false, id = null, expression = false, generator = false ) {
        return { type: 'ArrowFunctionExpression', params, body, async, id, expression, generator, };
    },
    
    // Other
    func( type, params, body, async = false, id = null, expression = false, generator = false ) {
        return { type, params, body, async, id, expression, generator, };
    },
    ...
    spreadElem( argument ) { return { type: 'SpreadElement', argument }; },
